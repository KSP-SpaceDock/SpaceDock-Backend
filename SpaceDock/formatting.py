...
def user_info(user):
    return {
        ...
        #Password skipped
        'description': user.description,
        'created': user.created.isoformat() if user.showCreated and not user.created == None else None,
        'showCreated': user.showCreated,
        'forumUsername': user.forumUsername if user.showForumName else "",
        'showForumName': user.showForumName,
        'ircNick': user.ircNick if user.showIRCName else "",
        'showIRCName': user.showIRCName,
        'twitterUsername': user.twitterUsername if user.showTwitterName else "",
        'showTwitterName': user.showTwitterName,
        'redditUsername': user.redditUsername if user.showRedditName else "",
        'showRedditName': user.showRedditName,
        'youtubeUsername': user.youtubeUsername if user.showYoutubeName else "",
        'showYoutubeName': user.showYoutubeName,
        'twitchUsername': user.twitchUsername if user.showTwitchName else "",
        'showTwitchName': user.showTwitchName,
        'facebookUsername': user.facebookUsername if user.showFacebookName else "",
        'showFacebookName': user.showFacebookName,
